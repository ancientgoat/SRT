...
public class MyOrganization extends Organization {
	 ...
	 */
	@Description(
			shortDefinition = "Contains a simple code indicating the billing code for this organization")
	...
	public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
		return ElementUtil.allPopulatedChildElements(theType,
				super.getAllPopulatedChildElementsOfType(theType), myBillingCode,
				myEmergencyContact);
	}
	...
	public static class EmergencyContact extends BaseIdentifiableElement implements IExtension {
		...
		@Extension(url = "http://foo#emergencyContactActive", isModifier = false,
				definedLocally = true)
		@Child(name = "active")
		...
		@Extension(url = "http://foo#emergencyContactContact", isModifier = false,
				definedLocally = true)
		@Child(name = "contact")
